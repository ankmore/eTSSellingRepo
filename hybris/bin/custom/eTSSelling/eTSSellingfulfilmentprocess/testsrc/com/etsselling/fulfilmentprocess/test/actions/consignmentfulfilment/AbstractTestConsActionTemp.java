 ...
 *  
 */
package com.etsselling.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, ETSSellingFulfilmentProcessConstants.PARENT_PROCESS);
