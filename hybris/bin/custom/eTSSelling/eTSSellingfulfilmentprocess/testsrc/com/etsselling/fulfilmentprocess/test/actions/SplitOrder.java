 ...
 *  
 */
package com.etsselling.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(ETSSellingFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(ETSSellingFulfilmentProcessConstants.PARENT_PROCESS);
