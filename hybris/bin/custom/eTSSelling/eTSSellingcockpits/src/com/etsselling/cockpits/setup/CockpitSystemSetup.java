 ...
 *  
 */
package com.etsselling.cockpits.setup;
...
import com.etsselling.cockpits.constants.ETSSellingCockpitsConstants;
 ...
 */
@SystemSetup(extension = ETSSellingCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(ETSSellingCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(ETSSellingCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						ETSSellingCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/eTSSellingcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
