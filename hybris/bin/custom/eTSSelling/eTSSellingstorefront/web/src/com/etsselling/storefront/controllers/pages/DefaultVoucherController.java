...
public class DefaultVoucherController extends AbstractPageController
{
			...
			final HttpServletRequest request)
	{
		try
		{
			...
			/*
			 * promotionGroup = promotionsService.getPromotionGroup("eTSSellingPromoGrp"); final List<PromotionGroupModel>
	...
	public String releaseVoucher()
	{
		try
		{
			...
			modelService.save(cartService.getSessionCart());
			promotionGroup = promotionsService.getPromotionGroup("eTSSellingPromoGrp");
