 ...
 *
 */
package com.etsselling.storefront.controllers.cms;
...
public class GenericCMSComponentController extends AbstractController
{
	...
	@Value("#{configurationService.configuration.getProperty('eTSSellingstorefront.generic.cms.component.controller.authorized.group')}")
