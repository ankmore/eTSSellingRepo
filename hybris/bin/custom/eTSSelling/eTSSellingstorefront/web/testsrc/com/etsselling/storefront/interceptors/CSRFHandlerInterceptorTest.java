 ...
 *  
 */
package com.etsselling.storefront.interceptors;
...
import com.etsselling.storefront.util.CSRFHandlerInterceptor;
import com.etsselling.storefront.util.CSRFTokenManager;
...
{
	private static final String SESSION_CSRF_ATTRIBUTE = "com.etsselling.storefront.util.CSRFTokenManager.tokenval";
