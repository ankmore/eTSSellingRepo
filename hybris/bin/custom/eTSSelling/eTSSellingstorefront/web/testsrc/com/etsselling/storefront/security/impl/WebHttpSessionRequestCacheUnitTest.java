...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/eTSSellingstorefront/electronics/en",
						"https://electronics.local:9002/eTSSellingstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/eTSSellingstorefront/electronics/en",
						"https://electronics.local:9002/eTSSellingstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/eTSSellingstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/eTSSellingstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/eTSSellingstorefront/electronics/en",
						"https://electronics.local:9002/eTSSellingstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/eTSSellingstorefront",
						"https://electronics.local:9002/eTSSellingstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/eTSSellingstorefront",
						"https://electronics.local:9002/eTSSellingstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/eTSSellingstorefront/electronics/en",
						"https://electronics.local:9002/eTSSellingstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
