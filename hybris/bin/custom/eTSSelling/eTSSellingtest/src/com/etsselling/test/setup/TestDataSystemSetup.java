 ...
 *  
 */
package com.etsselling.test.setup;
...
import com.etsselling.test.constants.ETSSellingTestConstants;
import com.etsselling.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = ETSSellingTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/eTSSellingtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/eTSSellingtest/import/reviews.impex");
			...
			importImpexFile(context, "/eTSSellingtest/import/cstickets.impex");
		}
	}
}
