 ...
 *  
 */
package com.etsselling.core.hmc;
...
/**
 * Provides necessary meta information about the eTSSellingcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class ETSSellingCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(ETSSellingCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.etsselling.core.hmc.locales";
